...
function SignUp() {
    ...
    const SignUp = async () => {
        const data = await useAuth.signUp(email, password)
        console.log(data)
        if (data?.data._id) {
                ...
                <div className="mt-10 mx-auto w-full max-w-sm">
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-3 text-lg text-center">New User! <NavLink to={'/login'} className="text-indigo-600">sign Up</NavLink></p>
                        </div>
